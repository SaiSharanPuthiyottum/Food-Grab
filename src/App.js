...
import Home from './components/Main_page/Main_page'
import useFetch from './Hooks/useFetch';
import { BrowserRouter as Router, Route, Routes } from 'react-router-dom';
import CheckoutPage from './components/Checkout/Checkout'
import ViewCart from './components/Cart_view/Cart_view'
import TransactionPage from './components/Payment/Payment'
function App() {
  //data fetching
